...
package com.swipeback.action.swipebackview.util;
...
public class ViewDragHelper {
     ...
     * callback's
     * {@link com.swipeback.action.swipebackview.util.ViewDragHelper.Callback#onEdgeTouched(int, int)}
     * and
     * {@link com.swipeback.action.swipebackview.util.ViewDragHelper.Callback#onEdgeDragStarted(int, int)}
     ...
     * {@link com.swipeback.action.swipebackview.util.ViewDragHelper.Callback#tryCaptureView(android.view.View, int)}
     ...
     * {@link com.swipeback.action.swipebackview.util.ViewDragHelper.Callback#getOrderedChildIndex(int)}
     * .
     *
     * @param x X position to test in the parent's coordinate system
     * @param y Y position to test in the parent's coordinate system
